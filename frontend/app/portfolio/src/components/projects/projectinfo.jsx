...
export const projectsInfo = [
    {
        ...
        "extendedInfo": ["• Developed a secure, self-hosted password manager using React, FastAPI, and SQL, eliminating third-party dependencies.",
        ...
        "chips": ["React", "FastAPI", "TortoiseORM", "Docker Compose", "Docker", "SQL", "Async", "Formik", "React Router", "Motion"]
    },
    {
        "id": 3,
        "title": "IoT Telemetry System",
        "date": "2025",
        "description": "Telemetry system for continous temperature and humidity monitoring",
        "link": "https://a9mansoo.github.io/Arduino/projects/temperature_humidity_sensor/",
        getImageSrc: () => iotImg,
        "extendedInfo": ["• Engineered a full-stack IoT telemetry system to monitor apartment humidity/temperature, integrating hardware (Arduino + DHT22  sensor), a custom distributable Python serial reader cli, and a metrics pipeline.",  
        ...
        "chips": ["Linux", "Python", "InfluxDB", "Docker", "Docker Compose", "Arduino", "Telegraf", "IoT"]
    },
    {
        "id": 2,
        ...
        getImageSrc: () => cellImg,
        "extendedInfo": ["• Engineered a computer vision application to detect animal cells.",
    ...
    },
    {
        ...
        getImageSrc: () => luckyShrubImg,
        "extendedInfo": ["• Responsive storefront site using modern CSS Grid/Flexbox, improving load performance and layout consistency across devices."],
